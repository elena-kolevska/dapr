...
| `global.rbac.createTokenReviewerRole`         | Creates a role and rolebinding for the token reviewer service account. This is required for the Dapr token service to work.                                                                             | `true`                                         |
